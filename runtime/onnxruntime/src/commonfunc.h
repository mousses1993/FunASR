...
inline void GetInputNames(Ort::Session* session,
                          std::vector<std::string>& m_strInputNames,
...
inline void GetOutputNames(Ort::Session* session,
                           std::vector<std::string>& m_strOutputNames,
