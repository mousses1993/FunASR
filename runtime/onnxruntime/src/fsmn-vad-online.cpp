...
void FsmnVadOnline::FbankKaldi(float sample_rate,
...
void FsmnVadOnline::ExtractFeats(float sample_rate,
                                 vector<std::vector<float>> &vad_feats,
...
int FsmnVadOnline::OnlineLfrCmvn(vector<vector<float>> &vad_feats,
                                 bool input_finished) {
...
std::vector<std::vector<int>> FsmnVadOnline::Infer(std::vector<float> &waves,
                                                   bool input_finished) {
  ...
  vad_segments =
      vad_scorer(vad_probs, waves, input_finished, true, vad_silence_duration_,
...
void FsmnVadOnline::InitOnline(std::shared_ptr<Ort::Session> &vad_session,
                               ...
                               int vad_sample_rate, int vad_silence_duration,
                               int vad_max_len, double vad_speech_noise_thres) {
...
FsmnVadOnline::FsmnVadOnline(FsmnVad *fsmnvad_handle)
    : fsmnvad_handle_(std::move(fsmnvad_handle)), session_options_{} {
  InitCache();
  InitOnline(fsmnvad_handle_->vad_session_, fsmnvad_handle_->env_,
             fsmnvad_handle_->vad_in_names_, fsmnvad_handle_->vad_out_names_,
             fsmnvad_handle_->fbank_opts_, fsmnvad_handle_->means_list_,
             fsmnvad_handle_->vars_list_, fsmnvad_handle_->vad_sample_rate_,
