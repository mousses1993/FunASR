...
class CTTransformerOnline : public PuncModel {
   ...
   * CT-Transformer: Controllable time-delay transformer for real-time
   * punctuation prediction and disfluency detection
 ...
 public:
  CTTransformerOnline();
  void InitPunc(const std::string& punc_model, const std::string& punc_config,
